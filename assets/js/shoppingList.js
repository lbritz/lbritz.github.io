...
function teste(){
     ...
     $.getJSON("../assets/data/segmentBCustomerData.json", function (data) {
        ...
        $.each(data, function(i, item){
                ...
                if (sClient === 871){
                    aItems = [sProduct, sProductDescription, sQuantity, sSellingPrice, sProductPrice];
                }
            });
    });
}

// crateItemCard(sProduct, sProductDescription, sQuantity, sSellingPrice, sProductPrice)
